...
class SeriesControllerIntegrationTests {
    ...
    public void whenPutSeries_thenReturnJsonSeries() throws Exception {
        Series seriesStudio1Movie1 = new Series("CoMix Wave Films", "Your name", "romance", true, 1, 2016);
        ...
        Series seriesStudio2Series1 = new Series("MAPPA", "Jujutsu Kaisen", false, 25, 1, 2020);
